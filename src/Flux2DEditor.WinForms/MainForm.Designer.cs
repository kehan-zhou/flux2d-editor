...
namespace Flux2DEditor.WinForms
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            toolStripShapeSelector.Items.AddRange(new ToolStripItem[] { toolStripButtonSelect, toolStripButtonRectangle, toolStripButtonCircle });
            ...
            // 
            toolStripButtonSelect.DisplayStyle = ToolStripItemDisplayStyle.Text;
            toolStripButtonSelect.Image = (Image)resources.GetObject("toolStripButtonSelect.Image");
            toolStripButtonSelect.ImageTransparentColor = Color.Magenta;
            toolStripButtonSelect.Name = "toolStripButtonSelect";
            toolStripButtonSelect.Size = new Size(58, 24);
            toolStripButtonSelect.Text = "Select";
            // 
            // MainForm
            // 
