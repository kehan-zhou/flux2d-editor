...
namespace Flux2DEditor.Core.Factories
{
    /// <summary>
    ...
    public static class ShapeFactory
    {
        ...
        private static readonly Dictionary<string, Func<BoundingBox, IShape>> _registry = new Dictionary<string, Func<BoundingBox, IShape>>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        public static void RegisterShape(string type, Func<BoundingBox, IShape> constructor)
        {
        ...
        public static IShape CreateShape(string type, BoundingBox bounds)
        {
